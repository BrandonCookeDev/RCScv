...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pagesTemplateJsx = __webpack_require__(200);

	var _pagesTemplateJsx2 = _interopRequireDefault(_pagesTemplateJsx);

	var _pagesDashboardIndexJsx = __webpack_require__(201);

	var _pagesDashboardIndexJsx2 = _interopRequireDefault(_pagesDashboardIndexJsx);

	var _modulesStreamControlJsx = __webpack_require__(202);

	var _modulesStreamControlJsx2 = _interopRequireDefault(_modulesStreamControlJsx);

	var routes = _react2['default'].createElement(_reactRouter.Route, { name: 'app', path: '/', handler: _pagesTemplateJsx2['default'] }, _react2['default'].createElement(_reactRouter.Route, { name: 'home', path: '/dasboard', handler: _pagesDashboardIndexJsx2['default'] }), _react2['default'].createElement(_reactRouter.DefaultRoute, { handler: _pagesDashboardIndexJsx2['default'] }));
	...
	_reactRouter2['default'].run(routes, function (Handler, state) {
	  ...
	  _react2['default'].render(_react2['default'].createElement(Handler, { params: params, path: path }), mountNode);
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DashboardPage = (function (_React$Component) {
	  ...
	  function DashboardPage() {
	    ...
	    _get(Object.getPrototypeOf(DashboardPage.prototype), 'constructor', this).apply(this, arguments);
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var JSON_PATH = '../../../../resources/test.json'; // todo change
	...
	var StreamControl = (function (_React$Component) {
	    ...
	    function StreamControl(props) {
	        _classCallCheck(this, StreamControl);

	        _get(Object.getPrototypeOf(StreamControl.prototype), 'constructor', this).call(this, props);
	    ...
	    _createClass(StreamControl, [{
	        ...
	        value: function handleSubmit() {
	            var postParams = this.state;
	            this.writeToFile();
	        }
	    }, {
	        key: 'updateState',
	        value: function updateState(json) {
	            this.state = json;
	        }
	    }, {
	        key: 'readFromFile',
	        value: function readFromFile() {
	            var _this = this;

	            //Call json file for reading
	            _axios2['default'].get(JSON_PATH).then(function (r) {
	                return r.json;
	            }).then(function (json) {
	                _this.updateStateFromJSON(json);
	            })['catch'](console.error);
	        }
	    }, {
	        key: 'writeToFile',
	        value: function writeToFile() {
	            ...
	            _axios2['default'].post(WRITE_JSON_URL, this.state).then(function (status) {
	                if (!status == 200) {
	                        ...
	                        _react2['default'].createElement(
	                            ...
	                            _react2['default'].createElement(
	                                ...
	                                _react2['default'].createElement(
	                                    'td',
	                                    null,
	                                    _react2['default'].createElement('input', { type: 'text', name: 'p1_name', placeholder: 'tag',
	                        ...
	                        _react2['default'].createElement(
	                            ...
	                            _react2['default'].createElement(
	                                ...
	                                _react2['default'].createElement(
	                                    'td',
	                                    null,
	                                    _react2['default'].createElement('input', { type: 'text', name: 'p2_name', placeholder: 'tag',
	...
	exports['default'] = StreamControl;

	_react3['default'].render(_react2['default'].createElement(StreamControl, null), document.getElementById('stream-control'));
	module.exports = exports['default'];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var deprecatedMethod = __webpack_require__(207);
	  ...
	  return new Promise(function (resolve, reject) {
	    try {
	      ...
	      if (typeof window !== 'undefined') {
	        __webpack_require__(209)(resolve, reject, config);
	      }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var urlIsSameOrigin = __webpack_require__(214);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4), __webpack_require__(217).setImmediate, (function() { return this; }()), __webpack_require__(219)(module)))
